   ...
   calculateDiff() {
    ...
    renderResult() {
     ...
     if(result === 0){
       ...
       return <div className="alert alert-success">Correct..move to the  nextlevel<Link to='#' class="btn btn-info danger"  >Nextlevel</Link></div>
      ...
      <div className="form-row align-items-center">
        <div className="col-auto">
          ...
          autoFocus
           ...
           placeholder="Enter number between 1 to 300..."/>
           <div className="col-auto">
